  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 animate-fade-in">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-fuchsia-500/10 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1.5 text-sm">Daftar untuk mulai melacak keuangan Anda</p>
        </div>
